...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split_3x6_8(
        ...
        KC_NUBS,     KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,              KC_N,        KC_M,        KC_COMM,     KC_DOT,      KC_SLSH,     KC_NUHS,
                                  MO(1),       KC_LSFT,     KC_BSPC,     KC_LCTL,           KC_RCTL,     SPC_SYM,     KC_RSFT,     MO(2),
...
const uint16_t PROGMEM super_combo[] = {KC_F, KC_R, COMBO_END};
const uint16_t PROGMEM ctrl_combo[] = {KC_D, KC_E, COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(super_combo, KC_LCTL),
    COMBO(ctrl_combo, KC_LGUI),
